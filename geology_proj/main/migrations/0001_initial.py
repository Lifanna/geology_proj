# Generated by Django 3.2.18 on 2023-03-23 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_enginery', models.TextField(default='Не назначено', null=True, verbose_name='Используемая техника')),
        ...
        migrations.AddField(
            model_name='license',
            name='watercourses',
            field=models.ManyToManyField(blank=True, through='main.LicenceWaterCourse', to='main.WaterCourse', verbose_name='Водотоки'),
        ),
        migrations.AddField(
            model_name='licencewatercourse',
            name='license',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.license', verbose_name='Лицензия'),
        ),
        migrations.AddField(
            model_name='licencewatercourse',
            name='parent_watercourse',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_watercourse', to='main.watercourse', verbose_name='Главный водоток'),
        ),
        migrations.AddField(
            model_name='licencewatercourse',
            name='watercourse',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.watercourse', verbose_name='Водоток'),
        ),
        migrations.AddField(
